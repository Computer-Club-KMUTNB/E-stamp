...
function App() {
  ...
  const loginUrl = import.meta.env.DEV ? 'http://localhost:3000/login' : '/login';
  ...
  return (
    <main className="hub-container">
      ...
      <section className="hub-hero">
        ...
        <div className="hub-actions"><a className="register-cta" href={registerUrl}><QrCode size={20} /> ลงทะเบียนรับ QR <ArrowUpRight size={18} /></a><a className="login-cta" href={loginUrl}>เข้าสู่ระบบ</a></div>
      </section>
