...
export default function RegisterPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      const createdStudent = await createStudent(code, name, faculty);
