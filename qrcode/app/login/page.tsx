...
export default function ParticipantLoginPage() {
  ...
  return <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-md place-items-center py-10">
    <section className="card w-full">
      ...
      <p className="mt-5 text-center text-sm text-slate-500">มีปัญหาการเข้าสู่ระบบ? กรุณาติดต่อที่บูธรับรางวัล ณ เต็นท์กองอำนวยการ ด้านหน้าเวทีลานสวนปาล์มหน้าตึก 40</p>
